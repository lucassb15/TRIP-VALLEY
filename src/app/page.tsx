          ...
          <form >
            <div className="flex flex-row justify-center items-center absolute mt-5 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-auto">
              ...
              <div className="relative">
                <i className="absolute top-3 lg:top-4  w-auto left-10 lg:left-14"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6">
